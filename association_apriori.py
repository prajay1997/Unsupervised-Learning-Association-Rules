...
groceries = []
with open(r"C:\Users\praja\Desktop\Data Science\Unsupervised learning Association Rules\groceries.csv") as f:
    groceries = f.read()
...
groceries = []
with open(r"C:\Users\praja\Desktop\Data Science\Unsupervised learning Association Rules\dataset\transactions_retail1.csv") as f:
    groceries = f.read()
...
frequent_itemsets = apriori(X, min_support = 0.01, max_len = 5, use_colnames = True)
